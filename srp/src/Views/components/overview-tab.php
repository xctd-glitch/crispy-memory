        ...
        <div class="grid gap-3 grid-cols-2 md:grid-cols-4">
            ...
            <div class="card p-3 text-center">
                <div class="inline-flex items-center justify-center gap-1.5 mb-1.5">
                    <img src="/assets/icons/favicon.svg" alt="Fox head logo" class="h-3.5 w-3.5" width="14" height="14">
                ...
                <p class="text-[10px] text-muted-foreground mt-0.5" x-text="getStatsResetInfo()"></p>
            </div>
            ...
            <div class="card p-3 text-center">
                ...
                <div class="text-xl font-semibold leading-tight"
                     x-text="formatNumber(totalDecisionA)"></div>
                <p class="text-[10px] text-muted-foreground mt-0.5" x-text="getStatsResetInfo()"></p>
            </div>
            ...
            <div class="card p-3 text-center">
                ...
                <div class="text-xl font-semibold leading-tight"
                     x-text="formatNumber(totalDecisionB)"></div>
                <p class="text-[10px] text-muted-foreground mt-0.5" x-text="getStatsResetInfo()"></p>
            </div>
        ...
        <div class="card p-4">
            ...
            <div class="grid gap-2 grid-cols-1 md:grid-cols-3">
                <button
                    ...
                    class="btn text-left justify-start btn-secondary border">
        ...
        <div class="card p-4">
            ...
            <div class="space-y-2 text-xs">
                ...
                <div class="flex justify-between py-2 border-b" x-show="cfg.system_on">
                    <span class="text-muted-foreground">Redirect URLs</span>
                    <span class="font-medium truncate ml-2 max-w-xs"
                          x-text="Array.isArray(cfg.redirect_url) && cfg.redirect_url.length > 0 ? cfg.redirect_url.length + ' URL(s)' : 'Not set'"></span>
                </div>
                <div class="flex justify-between py-2 border-b">
                ...
                <div class="flex justify-between py-2">
                    <span class="text-muted-foreground">Stats Reset</span>
                    <span class="font-medium text-xs" x-text="getStatsResetInfo()"></span>
                </div>
            </div>
        </div>
    </div>
